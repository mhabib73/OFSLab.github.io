...
organizations:
  - name: University of Central Florida, USA
    url: https://creol.ucf.edu/person/darren-hudson/

# Short bio (displayed in user profile at end of posts)
bio: Light-matter interactions using optical fibers; Emerging quantum technology
interests:
  - Hollow-core Fibers
...
employment:
  - title: Professor of Optics
    ...
    company_url: https://creol.ucf.edu/nfdl/
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:darren.hudson@ucf.edu'
  #- icon: twitter
   # icon_pack: fab
   # link: https://twitter.com/GeorgeCushen
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=qFbamTsAAAAJ&hl=en
  #- icon: github
    #icon_pack: fab
  ...
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/darrenhudson/
